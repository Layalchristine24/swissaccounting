...
```{r add-transaction-example, eval=FALSE}
...
- **Package-level function**: Available to all users via `swissaccounting::add_transaction()`
...
4. Transfers account 2891 to account 2850 (Private Account) or your specified equity account
...
- `transfer_to_account`: Equity account for final transfer (default: 2850L)
